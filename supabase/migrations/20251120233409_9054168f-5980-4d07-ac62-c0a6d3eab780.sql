...
DROP TABLE IF EXISTS public.verification_video_likes CASCADE;
DROP TABLE IF EXISTS public.verification_video_comments CASCADE;
DROP TABLE IF EXISTS public.verification_videos CASCADE;
DROP TABLE IF EXISTS public.verification_requests CASCADE;

-- Create verification_requests table with correct FK
...
-- Create verification_videos table with correct FK
...
-- Create verification_video_comments table with correct FK
...
-- Create verification_video_likes table with correct FK
...
CREATE INDEX idx_verification_videos_user_id ON public.verification_videos(user_id);
CREATE INDEX idx_verification_videos_share_code ON public.verification_videos(share_code);
CREATE INDEX idx_verification_video_comments_video_id ON public.verification_video_comments(video_id);
CREATE INDEX idx_verification_video_likes_video_id ON public.verification_video_likes(video_id);
